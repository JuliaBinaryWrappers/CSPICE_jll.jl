...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CSPICE_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("07f52509-e9d9-513c-a20d-3b911885bf96"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CSPICE", artifacts_toml) for e in artifacts["CSPICE"]]
...
if best_platform === nothing
    @debug("Unable to load CSPICE; unsupported platform $(triplet(platform_key_abi()))")
else
